...
class OrdersSyncConsumer(SyncConsumer):
    ...
    def websocket_connect(self, event):
        ...
        trace('Socket "%s" joins group "%s"' % (self.channel_name, settings.ORDERS_CHANNELS_NAME))
        async_to_sync(self.channel_layer.group_add)(
            settings.ORDERS_CHANNELS_NAME,
            self.channel_name
        )
    ...
    def websocket_disconnect(self, event):
        ...
        trace('Socket "%s" leaves group "%s"' % (self.channel_name, settings.ORDERS_CHANNELS_NAME))
