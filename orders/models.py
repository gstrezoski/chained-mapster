...
class OrganizationalUnit(models.Model):
    ...
    ou_id = models.PositiveBigIntegerField(_("Organization Unit ID"), blank=True, null=True)

    add_id = models.PositiveBigIntegerField(_("Address ID"),blank=True, null=True)

    client_name = models.CharField(_("Client Name"), max_length=255, blank=True, null=True, default=""
    )
    ...
    latitude = models.FloatField(_("Latitude"), blank=True, null=True, default=41.9172025)

    longitude = models.FloatField(_("Longitude"),blank=True, null=True, default=22.4067487)
